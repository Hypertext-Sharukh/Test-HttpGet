  ...
  describe('#getAllEmployees', () => {
    ...
    beforeEach(() => {
      ...
      expectedEmps = [
        { id: 101, name: 'Krishna' },
        { id: 102, name: 'Arjun' },
      ]  ;//Dummy data to be returned by request.s Employee[];
    });
    ...
    it('should return expected employees by calling once', () => {
      ...
      const x = httpTestingController.expectOne(empService.empUrl);
      expect(x.request.method).toEqual('GET');

      x.flush(expectedEmps); //Return expectedEmps
    });
